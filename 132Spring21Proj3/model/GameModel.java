...
public abstract class GameModel {
	...
	public GameModel(int rows, int cols) {
		...
		this.cols = cols;//normal copy
		
		this.rows = rows;//normal copy
		
		//created the rectangular board
		board = new BoardCell [rows][cols];
		
		//used a forloop to iterate through and assign it to empty
	 ...
	 */
	public int getRows() {//standard gatter for the rows
		return rows;
	}
	 ...
	 */
	public int getCols() {//standard getter for the cols
		return cols;
	}
	/**
	...
	public BoardCell getBoardCell(int rowIndex, int colIndex) {
		return board[rowIndex][colIndex];//getter for boardCell
	}
